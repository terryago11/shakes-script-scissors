...
| **Props tab** | Collapsible list of prop mentions (swords, letters, cups, torches, etc.) extracted from SD text; grouped by prop keyword with act/scene/line references |
