  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-sm">
        <h2 className="text-lg font-semibold text-stone-800 mb-4">New Cut</h2>
        ...
        <input
          ...
          className="w-full border border-stone-300 rounded px-3 py-2 text-sm mb-4 focus:outline-none focus:ring-2 focus:ring-amber-400"
          autoFocus
          onKeyDown={(e) => e.key === "Enter" && handleCreate()}
        />

        <label className="block text-sm text-stone-600 mb-1">Start from</label>
        <select
          value={cloneFrom}
          onChange={(e) => setCloneFrom(e.target.value)}
          className="w-full border border-stone-300 rounded px-3 py-2 text-sm mb-6 focus:outline-none"
        >
